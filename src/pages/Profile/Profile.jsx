...
import { UserCircle, Mail, Shield, Briefcase, University, School, Building, CheckCircle, XCircle, CalendarDays, AlertTriangle, Info, Image, Edit, X, Save } from 'lucide-react';
    ...
    <div className="flex items-center space-x-3 py-3 border-b border-blue-100 last:border-b-0">
      ...
      <div>
        ...
        <p className="text-md font-medium text-blue-800">
          {value === null || value === undefined || value === '' ? <span className="italic text-blue-400">N/A</span> : String(value)}
        </p>
      </div>
    </div>
  );
    ...
    return (
      <div className="flex justify-center items-center min-h-[calc(100vh-200px)] bg-gradient-to-br from-blue-50 to-white">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg font-medium text-blue-700">Loading Profile...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-blue-50 to-white min-h-screen">
      <div className="bg-white shadow-xl rounded-lg overflow-hidden max-w-2xl mx-auto border-2 border-blue-200">
            ...
            <div className="relative mb-4 sm:mb-0">
              {profileData.image_url ? (
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = `https://picsum.photos/seed/${profileData.id}/80/80`;
                  }}
                />
              ) : (
                <img 
                  src={`https://picsum.photos/seed/${profileData.id}/80/80`} 
                  alt="Profile"
                  className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg"
                />
              )}
        ...
        <div className="p-6 space-y-2 bg-white">
          <h2 className="text-xl font-semibold text-blue-800 mb-4 border-b border-blue-200 pb-2">Account Details</h2>
          ...
          <DetailItem 
            ...
            value={
              <div className="flex items-center space-x-3">
                <img 
                  src={profileData.image_url || `https://picsum.photos/seed/${profileData.id}/40/40`} 
                  alt="Profile thumbnail"
                  className="w-10 h-10 rounded-full object-cover border-2 border-blue-200"
                  onError={(e) => {
                    e.target.src = `https://picsum.photos/seed/${profileData.id}/40/40`;
                  }}
                />

                <span className="text-sm text-blue-600">
                  {profileData.image_url ? 'Custom profile image' : 'Generated placeholder image'}
                </span>
              </div>
            } 
          />
          ...
          {(profileData.authority_id || profileData.university_id || profileData.college_id || profileData.department_id) && (
            <>
              <h2 className="text-xl font-semibold text-blue-800 pt-6 mb-4 border-b border-blue-200 pb-2">Organizational Information</h2>
        ...
        <div className="fixed inset-0 bg-blue-900/75 flex justify-center items-center z-100 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md relative border-2 border-blue-200">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label htmlFor="imageUrl" className="block text-sm font-medium text-blue-700 mb-1">
                  Profile Image URL
                </label>
                <input
                  type="url"
              ...
              <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-md border border-blue-200">
                <img 
                  src={editImageUrl || `https://picsum.photos/seed/${profileData.id}/60/60`} 
                  alt="Preview"
                  className="w-15 h-15 rounded-full object-cover border-2 border-blue-300"
                  onError={(e) => {
                    e.target.src = `https://picsum.photos/seed/${profileData.id}/60/60`;
                  }}
                />
                <div>
