...
function UniversityTable({
  ...
  userRole,
  // This prop was not passed from University.jsx
    ...
    <table className="min-w-full divide-y divide-gray-200">
      <thead className="bg-gray-100 sticky top-0">
        <tr>
          ...
          {renderSortableHeader &&
            renderSortableHeader(
              translateUniversity("table.headers.established"),
              "since"
            )}
            ...
            >
              <td className="px-4 py-4">
                ...
                <img
                  src={`https://ui-avatars.com/api/?name=${encodeURIComponent(
                    uni.name || "University"
                  )}&background=4f46e5&color=fff&size=48&rounded=true`} // Added 'default' seed if id is missing
                  alt={`${uni.name || "Guest"} logo`}
              ...
              <td className="px-6 py-4 flex justify-center space-x-2">
                <button
                  ...
                  aria-label={translateUniversity("table.actions.viewDetails", {
                    name: uni.name,
                  })}
                ...
                {(userRole === "authority" || userRole === "admin") && (
                  <>
                    <button
                      ...
                      aria-label={translateUniversity(
                        "table.actions.editUniversity",
                        { name: uni.name }
                      )}
                    ...
                    <button
                      ...
                      aria-label={translateUniversity(
                        "table.actions.deleteUniversity",
                        { name: uni.name }
                      )}
