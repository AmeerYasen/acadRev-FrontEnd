export const ENDPOINTS = {
  ...
  COLLEGES: {
    ...
    GET_NAMES_BY_UNI: (universityId) =>
      `/colleges/getNamesByUni/${universityId}`,
  ...
  DEPARTMENTS: {
    ...
    PAGINATION: (page, perPage) =>
      `/departments/query?page=${page}&perPage=${perPage}`,
    GET_NAMES_BY_COLLEGE_ID: (collegeId) =>
      `/departments/getDepName/${collegeId}`,
  ...
  PROGRAMS: {
    ...
    PAGINATION: (page, perPage) =>
      `/programs/query?page=${page}&perPage=${perPage}`,
    GET_NAMES_BY_DEPARTMENT_ID: (departmentId) =>
      `/programs/getProgName/${departmentId}`,
...
export const QUANTITATIVE_ENDPOINTS = {
  ...
  GET_PROGRAM_RESPONSES: (area_id, programId) =>
    `/qnt/responses/${programId}/area/${area_id}`,
  GET_ALL_RESPONSES: "/qnt/responses",
  GET_AREA_SUMMARY_BY_ID: (areaId) => `/qnt/summary/${areaId}`,
  GET_USER_SUBMITTED_AREAS: (userId, programId) =>
    `/qnt/submitted/${userId}/${programId}`,
  GET_COMPLETED_AREAS: (programId) => `/qnt/completed/${programId}`,
  GET_AREA_PROGRESS: (programId) => `/qnt/progress/${programId}`,
  GET_MISSING_RESPONSES: (programId, areaId) =>
    `/qnt/missing/${programId}/${areaId}`,
...
export const REPORT_ENDPOINTS = {
  GET_DOMAINS: "/qual/domains",
  GET_PROMPTS: (page, perPage, domainId) =>
    `/report/prompts/${domainId}?page=${page}&perPage=${perPage}`,
...
export const STATISTICS_ENDPOINTS = {
  ...
  AUTHORITY: (authorityId) => `/statistics/authority/${authorityId}`,
  UNIVERSITY: (universityId) => `/statistics/university/${universityId}`,
  COLLEGE: (collegeId) => `/statistics/college/${collegeId}`,
  DEPARTMENT: (departmentId) => `/statistics/department/${departmentId}`,
  PROGRAM: (programId) => `/statistics/program/${programId}`,
};
